...
function RecipeForm() {
  ...
  const fetchRecipe = async () => {
    try {
      const res = await axios.get(
        `https://recipe-uni-server.onrender.com/recipe/${state}`
      );
      setRecipe(res.data);
  ...
  const fetchAllIngredients = async () => {
    try {
      const res = await axios.get(
        'https://recipe-uni-server.onrender.com/ingredient'
      );
  ...
  const deleteIngredientFromRecipe = async (id) => {
    try {
      const res = await axios.delete(
        `https://recipe-uni-server.onrender.com/recipe/${state}/ingredient/${id}`
      );
  ...
  const addIngredientToRecipe = async (id, amount, unit) => {
    try {
      const res = await axios.post(
        `https://recipe-uni-server.onrender.com/recipe/${state}/ingredient`,
        {
          ingredientId: id,
          amount: amount,
          unit: unit,
  ...
  const deleteIngredient = async (id) => {
    try {
      const res = await axios.delete(
        `https://recipe-uni-server.onrender.com/ingredient/${id}`
      );
      window.location.reload();
    } catch (e) {
      console.log(e);
